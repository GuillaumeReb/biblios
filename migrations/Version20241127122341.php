 ...
 */
final class Version20241127122341 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comment (id SERIAL NOT NULL, name VARCHAR(255) NOT NULL, email VARCHAR(255) DEFAULT NULL, create_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, published_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, status VARCHAR(255) NOT NULL, content TEXT NOT NULL, book VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
