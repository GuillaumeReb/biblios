 ...
 */
final class Version20241126171136 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (id SERIAL NOT NULL, editor_id INT NOT NULL, title VARCHAR(255) DEFAULT NULL, isbn VARCHAR(255) DEFAULT NULL, cover VARCHAR(255) DEFAULT NULL, edited_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, plot TEXT DEFAULT NULL, page_number INT DEFAULT NULL, status VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
